            ...
            <div className="mx-auto max-w-7xl space-y-12 px-4 sm:space-y-16 sm:px-6 lg:space-y-24 lg:px-8">
              <div className="space-y-4">
                ...
                <p
                  ...
                  style={{ filter: "blur(0px)", opacity: 1, transform: "none" }}
                >
                  Fullstack & DevOps Engineer specializing in NestJS, React, and
                  AWS
                </p>
                <div
                  style={{ filter: "blur(0px)", opacity: 1, transform: "none" }}
              ...
              >
                ...
                >
                          ...
                          <div style={{ minWidth: "100%", display: "table" }}>
                            ...
                            >
                              ...
                              <Button
                                ...
                                role="tab"
                                aria-selected="false"
                                aria-controls="radix-_R_n5fiv5ubsnpfj9b_-content-UI/UX Design"
                                data-state="inactive"
                                id="radix-_R_n5fiv5ubsnpfj9b_-trigger-UI/UX Design"
                                data-slot="tabs-trigger"
                                className="focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:outline-ring dark:data-[state=active]:border-input dark:text-muted-foreground inline-flex h-[calc(100%-1px)] flex-1 items-center gap-1.5 border-transparent whitespace-nowrap focus-visible:ring-[3px] focus-visible:outline-1 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:shadow-sm [&amp;_svg]:pointer-events-none [&amp;_svg]:shrink-0 [&amp;_svg:not([class*='size-'])]:size-4 hover:bg-muted data-[state=active]:bg-primary dark:data-[state=active]:bg-primary data-[state=active]:text-primary-foreground dark:data-[state=active]:text-primary-foreground text-muted-foreground w-full justify-start rounded-md border bg-transparent px-4 py-1.5 text-left text-base font-medium shadow-none transition-all"
                                tabIndex={-1}
                                data-orientation="vertical"
                              ...
                              <Button
                                ...
                                role="tab"
                                aria-selected="false"
                                aria-controls="radix-_R_n5fiv5ubsnpfj9b_-content-Web Development"
                                data-state="inactive"
                                id="radix-_R_n5fiv5ubsnpfj9b_-trigger-Web Development"
                                data-slot="tabs-trigger"
                                className="focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:outline-ring dark:data-[state=active]:border-input dark:text-muted-foreground inline-flex h-[calc(100%-1px)] flex-1 items-center gap-1.5 border-transparent whitespace-nowrap focus-visible:ring-[3px] focus-visible:outline-1 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:shadow-sm [&amp;_svg]:pointer-events-none [&amp;_svg]:shrink-0 [&amp;_svg:not([class*='size-'])]:size-4 hover:bg-muted data-[state=active]:bg-primary dark:data-[state=active]:bg-primary data-[state=active]:text-primary-foreground dark:data-[state=active]:text-primary-foreground text-muted-foreground w-full justify-start rounded-md border bg-transparent px-4 py-1.5 text-left text-base font-medium shadow-none transition-all"
                                tabIndex={-1}
                                data-orientation="vertical"
                  ...
                  <div
                    ...
                    data-orientation="vertical"
                    role="tabpanel"
                    aria-labelledby="radix-_R_n5fiv5ubsnpfj9b_-trigger-UI/UX Design"
                    id="radix-_R_n5fiv5ubsnpfj9b_-content-UI/UX Design"
                    tabIndex={0}
                  ...
                  <div
                    ...
                    data-orientation="vertical"
                    role="tabpanel"
                    aria-labelledby="radix-_R_n5fiv5ubsnpfj9b_-trigger-Web Development"
                    id="radix-_R_n5fiv5ubsnpfj9b_-content-Web Development"
                    tabIndex={0}
                    data-slot="tabs-content"
                    className="flex-1 outline-none mt-0"
                    hidden={true}
                  ...
                  <div
                    ...
                    data-orientation="vertical"
                    role="tabpanel"
                    aria-labelledby="radix-_R_n5fiv5ubsnpfj9b_-trigger-Graphic Design"
                    id="radix-_R_n5fiv5ubsnpfj9b_-content-Graphic Design"
                    tabIndex={0}
                    data-slot="tabs-content"
                    className="flex-1 outline-none mt-0"
                    hidden={true}
                  ...
                  <div
                    ...
                    data-orientation="vertical"
                    role="tabpanel"
                    aria-labelledby="radix-_R_n5fiv5ubsnpfj9b_-trigger-Product Management"
                    hidden={true}
                    id="radix-_R_n5fiv5ubsnpfj9b_-content-Product Management"
                    tabIndex={0}
                    data-slot="tabs-content"
                    className="flex-1 outline-none mt-0"
                  ></div>
                  <div
                    ...
                    data-orientation="vertical"
                    role="tabpanel"
                    aria-labelledby="radix-_R_n5fiv5ubsnpfj9b_-trigger-Content Writing"
                    hidden={true}
                    id="radix-_R_n5fiv5ubsnpfj9b_-content-Content Writing"
                    tabIndex={0}
                    data-slot="tabs-content"
                    className="flex-1 outline-none mt-0"
                  ></div>
                  <div
                    ...
                    data-orientation="vertical"
                    role="tabpanel"
                    aria-labelledby="radix-_R_n5fiv5ubsnpfj9b_-trigger-Web Design"
                    hidden={true}
                    id="radix-_R_n5fiv5ubsnpfj9b_-content-Web Design"
                    tabIndex={0}
                    data-slot="tabs-content"
                    className="flex-1 outline-none mt-0"
                  ></div>
